...
class ParticleSwarm:
    ...
    def run(self, verbose=2, step=10, c='blue'):        
        ...
        for i in range(len(self.functions)):
            ...
            if verbose >= 1:
                self.dispFunc(self.functions[i], particles, x, y, z, 'Initialization : ' + self.functions[i].__class__.__name__)
            ...
            while it <= self.max_it:
                ...
                if verbose == 2 and it % step == 0:
                    self.dispFunc(self.functions[i], particles, x, y, z, 'Iteration ' + str(it) + ' : ' + self.functions[i].__class__.__name__)
            ...
            if verbose >= 1:
                self.dispFunc(self.functions[i], particles, x, y, z, 'Convergence : ' + self.functions[i].__class__.__name__)